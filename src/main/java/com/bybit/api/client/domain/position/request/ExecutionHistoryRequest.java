 ...
 * orderLinkId	false	string	User customised order ID. Normal account does not support this param
 * baseCoin	false	string	Base coin. Unified account - inverse and Normal account do not support this param
 * startTime	false	integer	The start timestamp (ms)
 * endTime	false	integer	The end timestamp (ms)
 * execType	false	string	Execution type. Normal spot is not supported
